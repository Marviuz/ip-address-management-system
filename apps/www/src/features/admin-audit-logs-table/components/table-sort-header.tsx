...
import { type GetAuditLogsSchema } from '@ip-address-management-system/shared';
import { Button } from '@/components/common/button';

type TableSortButtonProps = {
  sortKey: GetAuditLogsSchema['sort'];
  children: ReactNode;
};
...
export const TableSortHeader: FC<TableSortButtonProps> = ({
  ...
  const { sort, order } = useSearch({ from: '/_authenticated/activity-logs/' });
